...
<body>
    ...
    <div class="container" style="margin-top:60px; position:sticky; top: 60px;">
        <ul class="nav nav-tabs centered-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="train_decision_tree.php">Train Decision Tree</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="train_random_forest.php">Train Random Forest</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="train_support_vector.php">Train Linear Support Vector</a>
            </li>

        </ul>
        <h1>Train Decision Tree Model</h1>
    ...
    <script>
        $("#train-button").click(function() {
            ...
            $.ajax({
                url: 'http://localhost:5000/train_decision_tree',
                type: 'POST',
